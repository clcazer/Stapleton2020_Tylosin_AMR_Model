...
%Pop model parameters
    N_c=repmat(150,1,n); %number of cattle in the pen: head
    ...
    Trough_head=unifrnd(26500/11,530000/11,1,n); %size of water trough: g-Water / head
    Trough=Trough_head.*N_c; %size of water trough: g-Water
    ...
    Bunk_head=unifrnd(100000/11,170000/11,1,n); %size of feed bunk: g-Feed/head
    Bunk=Bunk_head.*N_c; %size of feed bunk: g-Feed
    ...
    Ingested_death=unifrnd(0.5,0.9,1,n); %death penalty to ingested bacteria moving from feed, water, and 
        ...
        %unitless
    Pen_head=unifrnd(30000/11,50000/11,1,n); %amt of ingestible pen material: g-Pen/head
    Pen=Pen_head.*N_c; %amt of ingestible pen material: g-Pen
